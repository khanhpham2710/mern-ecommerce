...
import { DisplayPriceInUSD } from '../utils/DisplayPriceInRupees'
                        ...
                        <>
                                                ...
                                                return(
                                                    <div key={item?._id+"cartItemDisplay"} className='flex  w-full gap-4'>
                                                        ...
                                                        <div className='w-full max-w-sm text-xs'>
                                                            ...
                                                            <p className='font-semibold'>{DisplayPriceInUSD(pricewithDiscount(item?.productId?.price,item?.productId?.discount))}</p>
                                                        </div>
                                                        <div>
                            ...
                            <div className='bg-white p-4'>
                                ...
                                <div className='flex gap-4 justify-between ml-1'>
                                    <p>Items total</p>
                                    <p className='flex items-center gap-2'><span className='line-through text-neutral-400'>{DisplayPriceInUSD(notDiscountTotalPrice)}</span><span>{DisplayPriceInUSD(totalPrice)}</span></p>
                                </div>
                                <div className='flex gap-4 justify-between ml-1'>
                                    <p>Quntity total</p>
